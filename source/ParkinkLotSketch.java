...
public class ParkinkLotSketch extends PApplet {
...
final int greyblack = color(50);
final int greywhite = color(200);
final int white = color(255);
final int red = color(255,50,50);
final int blue = color(50,50,255);
...
public void drawtable(int myRows, int myColumns)
{
...
public void lineSettings(int strokeColor, int strokeSize)
{
  stroke(strokeColor);
  strokeWeight(strokeSize);
}

public void drawblocos(int dim, boolean hor, int c, float x, float y)
{
...
public void limitesX(float ax, float dim)
{
  if(cellHeight <= cellWidth)
  {
...
public void limitesY(float ay, float dim)
{
  if(cellHeight <= cellWidth)
  {
...
public void obstaculoX(float x1,float y1, int dim1, float x2,float y2, int dim2)
{
  if(cellHeight <= cellWidth)
  {
...
public void obstaculoY(float x1, float y1, int dim1, float x2, float y2, int dim2)
{
  if(cellHeight <= cellWidth)
  {
...
public void obstaculoXsame(float x1, float dim1, float x2, float dim2)
{
  if(cellHeight <= cellWidth)
  {
...
public void obstaculoYsame(float y1, float dim1, float y2, float dim2)
{
  if(cellHeight <= cellWidth)
  {
...
public void mover4()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ParkinkLotSketch" };
    if (passedArgs != null) {
